...
class TwitterClient:
    ...
    def _ensure_client_transaction(self):
        ...
        try:
            ...
            # Pass our active credentials to bypass unauthenticated login wall redirects
            cookie_val = self._cookie_string or "auth_token=%s; ct0=%s" % (self._auth_token, self._ct0)
            if cookie_val:
                ct_headers["Cookie"] = cookie_val
